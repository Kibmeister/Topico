...
templates['groups'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n"
    + ((stack1 = helpers.unless.call(alias1,(depth0 != null ? depth0.words : depth0),{"name":"unless","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
